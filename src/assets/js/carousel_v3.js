//container = div externo


export class CarouselV3{
    constructor(container){
        this.container = document.querySelector(container);
        this.carouselInner = this.container.querySelector('.slider-contenedor');
    }
    let prev = document.querySelector('.carousel-controls .prev');
    let next = document.querySelector('.carousel-controls .next');
    let slides =  document.querySelectorAll('.slider-contenedor .contenido-slider');
  ...
  //   loadIndicators();
    ...
    //EVENTOS PARA INDICADORES DE CARRUSEL
  ...
  //   });
    ...
    //LOGICA DE INDICADORES Y SUS UPDATES
